...
import { Logout, Chart, Gallery, TestTube, Calculator, Home, Key, Box, User as UserIcon } from "@solar-icons/react";
...
export function Dashboard({ onLogout }: DashboardProps) {
  ...
  const [activeSubTab, setActiveSubTab] = useState<"media" | "concept-test" | "price-simulator" | "product" | "persona">("media");
      ...
      {isSidebarOpen && (
        ...
        <SidebarHeader>
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-semibold text-black dark:text-white">API Dashboard</h2>
          </div>
        </SidebarHeader>
        <SidebarContent>
          <SidebarGroup>
            ...
            <div className="ml-4 mt-2 mb-2 space-y-1 border-l-2 border-[#e5e5e5] dark:border-[#1f1f1f] pl-2">
              <SidebarSubItem 
                ...
                className={`transition-all duration-200 ${
                  location.pathname === "/dashboard/usage" && activeSubTab === "media" 
              ...
              <SidebarSubItem 
                ...
                className={`transition-all duration-200 ${
                  location.pathname === "/dashboard/usage" && activeSubTab === "concept-test" 
                    ? "bg-[#00c950]/10 text-[#00c950] font-medium" 
                    : "text-[#666666] dark:text-[#999999] hover:bg-[#f5f5f5] dark:hover:bg-[#1a1a1a] hover:text-black dark:hover:text-white"
                }`}
              >
              ...
              <SidebarSubItem 
                ...
                className={`transition-all duration-200 ${
                  location.pathname === "/dashboard/usage" && activeSubTab === "price-simulator" 
                    ? "bg-[#00c950]/10 text-[#00c950] font-medium" 
                    : "text-[#666666] dark:text-[#999999] hover:bg-[#f5f5f5] dark:hover:bg-[#1a1a1a] hover:text-black dark:hover:text-white"
                }`}
              >
              ...
              <SidebarSubItem 
                ...
                className={`transition-all duration-200 ${
                  location.pathname === "/dashboard/usage" && activeSubTab === "product" 
                    ? "bg-[#00c950]/10 text-[#00c950] font-medium" 
                    : "text-[#666666] dark:text-[#999999] hover:bg-[#f5f5f5] dark:hover:bg-[#1a1a1a] hover:text-black dark:hover:text-white"
                }`}
              >
              ...
              <SidebarSubItem 
                ...
                className={`transition-all duration-200 ${
                  location.pathname === "/dashboard/usage" && activeSubTab === "persona" 
                    ? "bg-[#00c950]/10 text-[#00c950] font-medium" 
                    : "text-[#666666] dark:text-[#999999] hover:bg-[#f5f5f5] dark:hover:bg-[#1a1a1a] hover:text-black dark:hover:text-white"
                }`}
              >
        ...
        <SidebarFooter className="space-y-3">
          {/* Usage Card */}
          <Card size="sm" className="bg-[#e8f5e9] dark:bg-[#1a3d1f] border-[#c8e6c9] dark:border-[#2d5a33] rounded-lg p-1.5">
            <CardContent className="p-0 space-y-1.5">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-black dark:text-white">Usage</span>
                <span className="text-xs text-gray-600 dark:text-gray-400">
                  {userData && userData.total_credits > 0
                    ? ((userData.credits_consumed / userData.total_credits) * 100).toFixed(1)
                    : "0.0"}%
                </span>
              </div>
              ...
              <div className="w-full h-1 bg-[#c8e6c9] dark:bg-[#2d5a33] rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: userData && userData.total_credits > 0
                      ? `${Math.min((userData.credits_consumed / userData.total_credits) * 100, 100)}%`
                      : "0%",
                  }}
                />
              </div>
      ...
      <main className="flex-1 overflow-y-auto bg-white dark:bg-[#111111] m-4 rounded-xl shadow-sm border border-[#e5e5e5] dark:border-[#1f1f1f]">
        <div className="container mx-auto px-6 py-6">
          <Routes>
            ...
            <Route path="/usage" element={<Usage activeSubTab={activeSubTab} onSubTabChange={setActiveSubTab} />} />
